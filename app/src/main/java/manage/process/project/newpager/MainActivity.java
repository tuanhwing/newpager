package manage.process.project.newpager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dealStatusBar(); // 调整状态栏高度(Customize toolbar)

        // 2. 初始化ImageLoader (Initialize ImageLoader)
        initImageLoader();

        // 3. 填充ViewPager (Fill content view pager)
        fillViewPager();
    }
